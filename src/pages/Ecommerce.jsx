...
// Components
import { Stacked, SparkLine, Pie, Button } from '../components/Index';
  ...
  return (
    <div className="mt-24">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 drak:bg-secondary-dark-bg
        h-44 rounded-xl w-full lg:w-60 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat
        bg-cover bg-center"style={{backgroundColor:"#9ae1ff"}}>
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold" style={{color:"#340861"}}>Earnings</p>
              <p className="text-2xl" style={{color:"#2e3192"}}>46,120,000</p>
            </div>
          </div>
          <div className="mt-6">
            <Button 
            ...
            ">
              ...
              <div className="flex mt-10 gap-10 flex-wrap justify-center">
                <div className="border-r-1 border-color m-4 pr-10">
                  <div>
                    <p>
                      <span className="text-3xl font-semibold">$94,458</span>
                  ...
                  <div className="mt-8">
                    <p>
                      <span className="text-3xl font-semibold">$57,458</span>
                    </p>
                    <p className="text-gray-500 mt-1">
                      Expense
                    </p>
                ...
                {/* Stacked chart at right side of Sparkline chart */}
                <div>
