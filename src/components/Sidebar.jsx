...
const Sidebar = () => {
  ...
  const normalLink =
    "flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-gray-700 dark:text-gray-200 text-md dark:hove:text-black hover:bg-light-gray m-2";
    ...
    ">
        {
          ...
          {/* For Actual Items-Loop For Items With Map */}
          <div claaName="mt-10">
            {
              links.map((item) => (
                <div key={item.title}>
