...
// Components
import { Footer, Navbar, Sidebar, ThemeSettings } from "./components/Index.jsx"
...
const App = () => {
  const { activeMenu, setCurrentColor, setCurrentMode, currentMode, currentColor, themeSettings, setThemeSettings } = useStateContext();
    ...
    <div className={currentMode === "Dark" ? "dark" : "light"}>
      <div className="flex relative dark:bg-main-dark-bg">
        ...
        {activeMenu ? (
          ...
          fixed dark:bg-secondary-dark-bg
          bg-white">
            <Sidebar />
          </div>
        ) : (
